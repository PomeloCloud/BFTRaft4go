...
type BFTRaftClient interface {
	...
	AppendEntries(ctx context.Context, in *AppendEntriesRequest, opts ...grpc.CallOption) (*Nothing, error)
}
...
func (c *bFTRaftClient) AppendEntries(ctx context.Context, in *AppendEntriesRequest, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
type BFTRaftServer interface {
	...
	AppendEntries(context.Context, *AppendEntriesRequest) (*Nothing, error)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
